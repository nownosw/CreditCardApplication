...
$(document).ready(function () {
  ...
  var series = [
    {
      ...
      // pointStart: Date.UTC(2022, 3, 22),
      data: myData(),
      // data: [
      //    [Date.UTC(2010, 0, 2), 29.9],
      //    [Date.UTC(2010, 0, 4), 71.5],
      //    [Date.UTC(2010, 0, 6), 0],
      //    [Date.UTC(2010, 0, 11), 106.4],
      //    [Date.UTC(2010, 0, 22), 129.2],
      //    [Date.UTC(2010, 0, 25), 144.0],
      //    [Date.UTC(2010, 0, 28), 176.0]
      // ]
    },
  ];
  ...
  function myData() {
    ...
    console.log(Date.UTC(2022,3,22))
    console.log(GraphData[0][0]==Date.UTC(2022,3,22))
